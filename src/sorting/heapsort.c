...
static void
swap_pointed(u8* restrict pos1, u8* restrict pos2, size_t datasize);

static void
heapify(void* restrict data, size_t size, size_t length, size_t index, i32 (*comparator)(const void*, const void*));

static void
build_heap(void* restrict data, size_t size, size_t length, i32 (*comparator)(const void*, const void*));
...
// -------------------------------------------------------------------------------------------------
void
heapsort_sort(void* restrict data, size_t size, size_t length, i32 (*comparator)(const void*, const void*))
{
...
// -------------------------------------------------------------------------------------------------
i32
is_sorted(void* restrict data, size_t size, size_t length, i32 (*comparator)(const void*, const void*))
{
    size_t pos = 0u;
