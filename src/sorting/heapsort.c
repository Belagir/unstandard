...
static void heapify(range *array, size_t length_heap, size_t index, range_comparator_f comparator);

static void build_heap(range *array, range_comparator_f comparator);
