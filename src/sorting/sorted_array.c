...
size_t sorted_range_remove_from(rrange_any haystack, rrange_comparator comparator, void *needle)
{
    ...
    rrange_remove(haystack, found_pos);
...
size_t sorted_range_insert_in(rrange_any haystack, rrange_comparator comparator, void *inserted_needle)
{
    ...
    rrange_insert_value(haystack, theorical_position, inserted_needle);
...
tst_CREATE_TEST_SCENARIO(sorted_array_u32_find,
        ...
        },
        {
            ...
            size_t found = sorted_range_find_in(rrange_to_any(&data->array), &test_u32_comparator, (void *) &data->needle, &theorical_pos);
...
tst_CREATE_TEST_CASE(sorted_array_u32_find_nominal, sorted_array_u32_find,
        .array             = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle            = 13u,
...
tst_CREATE_TEST_CASE(sorted_array_u32_find_other_array, sorted_array_u32_find,
        .array             = rrange_create_static(u32, 20, { 8u, 12u, 18u, 64u, 65u, 65u, 65u, 132u, 256u, 280u, 290u, 300u, 301u, 302u, 303u, 389u, 395u, 400u, 4025u, 5000u }),
        .needle            = 301u,
...
tst_CREATE_TEST_CASE(sorted_array_find_first_occ_adjacent, sorted_array_u32_find,
        .array             = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 13u, 13u, 13u, 17u, 18u, 19u }),
        .needle            = 13u,
        .expected_position = 13u,
        .expect_success    = 1u)
// -------------------------------------------------------------------------------------------------
...
tst_CREATE_TEST_SCENARIO(sorted_array_remove_element,
        ...
        {
            size_t deletion_pos = sorted_range_remove_from(rrange_to_any(&data->array), &test_u32_comparator, (void *) &data->needle);
...
tst_CREATE_TEST_CASE(sorted_array_remove_element_nominal, sorted_array_remove_element,
        .array           = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle          = 15u,
        .expected_array  = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 16u, 17u, 18u, 19u, 0u }),
        .expect_deletion = 1u)

tst_CREATE_TEST_CASE(sorted_array_remove_element_nominal_2, sorted_array_remove_element,
        .array           = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle          = 14u,
        .expected_array  = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 15u, 16u, 17u, 18u, 19u, 0u }),
        .expect_deletion = 1u)

tst_CREATE_TEST_CASE(sorted_array_remove_element_at_start, sorted_array_remove_element,
        .array           = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle          = 0u,
        .expected_array  = rrange_create_static(u32, 20, { 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u, 0u }),
        .expect_deletion = 1u)

tst_CREATE_TEST_CASE(sorted_array_remove_element_at_end, sorted_array_remove_element,
        .array           = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle          = 19u,
        .expected_array  = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 0u }),
        .expect_deletion = 1u)

tst_CREATE_TEST_CASE(sorted_array_remove_element_not_found, sorted_array_remove_element,
        .array           = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .needle          = 20u,
        .expected_array  = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 16u, 17u, 18u, 19u }),
        .expect_deletion = 0u)
// -------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------------------------------
...
tst_CREATE_TEST_SCENARIO(sorted_array_insert,
        ...
        },
        {
            ...
            size_t insertion_pos = sorted_range_insert_in(rrange_to_any(&data->array), &test_u32_comparator, (void *) &data->inserted_element);
...
tst_CREATE_TEST_CASE(sorted_array_insert_nominal, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 12u, 13u, 14u, 15u, 0u, 0u, 0u, 0u }),
        .array_length      = 15u,
        .inserted_element  = 11u,
        .expected_position = 11u,
        .expected_array    = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 0u, 0u, 0u }),
)
tst_CREATE_TEST_CASE(sorted_array_insert_at_beginning, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 0u, 0u, 0u, 0u }),
        .array_length      = 15u,
        .inserted_element  = 0u,
        .expected_position = 0u,
        .expected_array    = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u, 0u, 0u, 0u }),
...
tst_CREATE_TEST_CASE(sorted_array_insert_second_position, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 1u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u }),
        .array_length      = 1u,
        .inserted_element  = 2u,
        .expected_position = 1u,
        .expected_array    = rrange_create_static(u32, 20, { 1u, 2u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u }),
)
tst_CREATE_TEST_CASE(sorted_array_insert_penultimate, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 1u, 2u, 3u, 5u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u }),
        .array_length      = 4u,
        .inserted_element  = 4u,
        .expected_position = 3u,
        .expected_array    = rrange_create_static(u32, 20, { 1u, 2u, 3u, 4u, 5u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u }),
)
tst_CREATE_TEST_CASE(sorted_array_insert_at_end, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 0u, 0u, 0u, 0u, 0u }),
        .array_length      = 15u,
...
tst_CREATE_TEST_CASE(sorted_array_u32_insert_other, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { 8u, 12u, 18u, 64u, 65u, 65u, 65u, 132u, 256u, 280u, 290u, 300u, 301u, 302u, 303u, 389u, 395u, 400u, 4025u, 0u }),
        .array_length      = 19u,
        .inserted_element  = 390u,
        .expected_position = 16u,
        .expected_array    = rrange_create_static(u32, 20, { 8u, 12u, 18u, 64u, 65u, 65u, 65u, 132u, 256u, 280u, 290u, 300u, 301u, 302u, 303u, 389u, 390u, 395u, 400u, 4025u }),
)
tst_CREATE_TEST_CASE(sorted_array_u32_insert_in_empty, sorted_array_insert,
        .array             = rrange_create_static(u32, 20, { }),
        .array_length      = 0u,
        .inserted_element  = 42u,
        .expected_position = 0u,
        .expected_array    = rrange_create_static(u32, 20, { 42u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u }),
)
// -------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------------------------------
