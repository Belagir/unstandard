...
// -------------------------------------------------------------------------------------------------
ttree_path *ttree_get_path_relative(allocator alloc, ttree_path *base_path, rrange_any elements_range, comparator_f comp)
{
    ttree_path *new_path = { };
    ttree *tree = { };
    ...
    rrange_insert_range(rrange_to_any(new_path->tokens_indexes), 0u, rrange_to_any(base_path->tokens_indexes));
    ...
    while ((pos < limit) && (pos_elements < elements_range.r->length)) {
        if (comp(rrange_at(elements_range, pos_elements), rrange_at(tree->tree_contents, pos)) == 0u) {
            rrange_insert_value(rrange_to_any(new_path->tokens_indexes), new_path->tokens_indexes->length, (void *) &pos);
            limit = pos + tree->tree_children->data[pos] + 1u;
            pos += 1u;
            pos_elements += 1u;
        } else {
...
ttree_mishap ttree_path_destroy(allocator alloc, ttree_path **path)
{
    ...
    rrange_destroy_dynamic(alloc, &rrange_to_any((*path)->tokens_indexes));
...
ttree_mishap ttree_foreach_element(const ttree_path *path, void (apply_f)(void *element, void *additional_args), void *additional_args)
{
    ...
    for (size_t i = apply_from ; i < apply_to ; i++) {
        apply_f(rrange_at(path->target->tree_contents, i), additional_args);
    }
...
tst_CREATE_TEST_SCENARIO(tree_search_path,
        {
            ...
            rrange(u32, 10) searched_path;

            bool expect_found;
            rrange(size_t, 10) expected_indexes;
        },
        {
            ttree tree = {};
            ...
            ttree_path *path = ttree_get_path_absolute(make_system_allocator(), &tree, rrange_to_any(&data->searched_path), &test_comparator_u32);
...
tst_CREATE_TEST_CASE(tree_search_present, tree_search_path,
        .tree_start_state_contents = rrange_create_static(u32, 10,    { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 83, 84, 86 }),
        .expect_found              = true,
        .expected_indexes          = rrange_create_static(size_t, 10, { 3, 4, 6 }),
)
tst_CREATE_TEST_CASE(tree_search_present_node, tree_search_path,
        .tree_start_state_contents = rrange_create_static(u32, 10,    { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 87, 88 }),
        .expect_found              = true,
        .expected_indexes          = rrange_create_static(size_t, 10, { 7, 8 }),
)
tst_CREATE_TEST_CASE(tree_search_absent, tree_search_path,
        .tree_start_state_contents = rrange_create_static(u32, 10,    { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 83, 88, 86 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_too_far, tree_search_path,
        .tree_start_state_contents = rrange_create_static(u32, 10,    { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 83, 84, 86, 91 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_empty_path, tree_search_path,
        .tree_start_state_contents = rrange_create_static(u32, 10,    { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, {  } ),
        .expect_found              = true,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_empty_tree, tree_search_path,
        ...
        .searched_path             = rrange_create_static(u32, 10, { 1 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
...
tst_CREATE_TEST_CASE(tree_search_adjacent, tree_search_path,
        ...
        .searched_path             = rrange_create_static(u32, 10, { 41, 42, 44 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, { }),
)
...
tst_CREATE_TEST_SCENARIO(search_relative,
    {
            ...
            rrange(u32, 10) searched_path;
            rrange(u32, 10) relative_to_path;
    ...
    },
    {
            ...
            ttree_path *base_path = ttree_get_path_absolute(make_system_allocator(), &tree, rrange_to_any(&data->relative_to_path), &test_comparator_u32);
            ttree_path *path = ttree_get_path_relative(make_system_allocator(), base_path, rrange_to_any(&data->searched_path), &test_comparator_u32);
...
tst_CREATE_TEST_CASE(tree_search_relative_valid_and_valid, search_relative,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 81 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 80 }),
        .expect_found              = true,
        .expected_indexes          = rrange_create_static(size_t, 10, { 0, 1 }),
)
tst_CREATE_TEST_CASE(tree_search_relative_invalid_and_valid, search_relative,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 81, 85 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 80 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_relative_empty_and_valid, search_relative,
        ...
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, {  }),
        .relative_to_path          = rrange_create_static(u32, 10, { 83, 84 }),
        .expect_found              = true,
        .expected_indexes          = rrange_create_static(size_t, 10, { 3, 4 }),
)
tst_CREATE_TEST_CASE(tree_search_relative_toolong_and_valid, search_relative,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 85, 86 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 83, 84 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_relative_valid_and_invalid, search_relative,
        ...
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 87, 88 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 88 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_relative_invalid_and_invalid, search_relative,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 89, 88 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 88 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
...
tst_CREATE_TEST_CASE(tree_search_relative_toolong_and_invalid, search_relative,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 80, 81, 82, 83, 84, 85, 86, 87, 88, 89 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, { 83, 84, 85, 86 }),
        .relative_to_path          = rrange_create_static(u32, 10, { 88 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
tst_CREATE_TEST_CASE(tree_search_relative_empty_and_toolong, search_relative,
        ...
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2,  0,  0,  3,  2,  0,  0,  2,  1,  0 }),
        .searched_path             = rrange_create_static(u32, 10, {  }),
        .relative_to_path          = rrange_create_static(u32, 10, { 83, 84, 85, 86 }),
        .expect_found              = false,
        .expected_indexes          = rrange_create_static(size_t, 10, {  }),
)
...
tst_CREATE_TEST_CASE(tree_foreach_element_sum_part, tree_foreach_element,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 10, 5, 4, 9, 1, 6, 3, 1, 2, 1 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2, 1, 0, 4, 0, 0, 0, 0, 1, 0 }),
        .path_to_iterate = rrange_create_static(size_t, 10, { 10, 5 }),
        .apply_f = &test_apply_sum,
        .additional_args = (void *) &(u32) { 0u },
        .additional_args_size = sizeof(u32),
        .tree_end_state_contents = rrange_create_static(u32, 10,   { 10, 5, 4, 9, 1, 6, 3, 1, 2, 1 }),
...
tst_CREATE_TEST_CASE(tree_foreach_element_sum_nothing, tree_foreach_element,
        .tree_start_state_contents = rrange_create_static(u32, 10,   { 10, 5, 4, 9, 1, 6, 3, 1, 2, 1 }),
        .tree_start_state_children = rrange_create_static(size_t, 10, { 2, 1, 0, 4, 0, 0, 0, 0, 1, 0 }),
        .path_to_iterate = rrange_create_static(size_t, 10, { 10, 5, 99 }),
        .apply_f = &test_apply_sum,
        .additional_args = (void *) &(u32) { 0u },
        .additional_args_size = sizeof(u32),
        .tree_end_state_contents = rrange_create_static(u32, 10,   { 10, 5, 4, 9, 1, 6, 3, 1, 2, 1 }),
...
tst_CREATE_TEST_CASE(tree_foreach_element_incr_whole, tree_foreach_element,
        ...
        .additional_args = (void *) &(u32) { 0u },
        .additional_args_size = sizeof(u32),
        .tree_end_state_contents = rrange_create_static(u32, 10,   { 11, 6, 5, 10, 2, 7, 4, 2, 3, 2 }),
        .tree_end_state_children = rrange_create_static(size_t, 10, { 2, 1, 0, 4, 0, 0, 0, 0, 1, 0 }),
        .end_state_additional_args = (void *) &(u32) { 0u },
)
